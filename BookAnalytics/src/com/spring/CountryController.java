...
public class CountryController {
	...
	static {
		...
		authors.put("123", new AuthorYear("Love in the Time of Cholera", "Hugh Jackson", "Hugh Michael Jackman"));
		authors.put("124", new AuthorYear("Journey", "Jennifer Lawrence", "Jennifer Shrader Lawrence"));
		authors.put("345", new AuthorYear("Nina: Adolescence", "Jennifer Lopez", "Jennifer Lynn Lopez"));
		authors.put("6456", new AuthorYear("Shattered", "Africa Fine", "10"));
		authors.put("564", new AuthorYear("Harlem Sunset", "Peter Maas", "10"));
