...
public class RecommendController {
	...
	static {
		...
		authors.put("123", new AuthorYear("White Lies", "Hugh Jackson", "Hugh Michael Jackman"));
		authors.put("124", new AuthorYear("Arcadia", "Jennifer Lawrence", "Jennifer Shrader Lawrence"));
		authors.put("345", new AuthorYear("The Husband Test", "Jennifer Lopez", "Jennifer Lynn Lopez"));
		authors.put("436", new AuthorYear("Forever and Always", "Jennifer Lawrence", "Jennifer Shrader Lawrence"));
		authors.put("345564", new AuthorYear("The Princess of Pop ", "Jennifer Lopez", "Jennifer Lynn Lopez"));
