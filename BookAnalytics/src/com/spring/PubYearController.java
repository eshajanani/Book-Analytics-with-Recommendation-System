...
public class PubYearController {
	...
	static {
		...
		authors.put("123", new AuthorYear("2000", "Jonlin Books", "10"));
		authors.put("124", new AuthorYear("2001", "HarperCollins Publishers", "9"));
		authors.put("345", new AuthorYear("2002", "Viking Books", "8"));
		authors.put("345", new AuthorYear("2003", "Pocket Star", "9"));
		authors.put("345", new AuthorYear("2004", "Signet Book", "9"));
